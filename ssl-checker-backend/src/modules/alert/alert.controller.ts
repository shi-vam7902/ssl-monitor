...
export class AlertController {
  ...
  @ApiOperation({
    ...
    description:
      "Add new domain for SSL certificate monitoring (SUPER_ADMIN only)",
  })
  @ApiResponse({
    status: 201,
  ...
  @ApiResponse({
    status: 400,
    description: "Domain already exists or invalid domain",
  })
  @ApiResponse({
    status: 403,
  ...
  @ApiOperation({
    ...
    description:
      "Get paginated list of all monitored domains with SSL information",
  })
  @ApiResponse({
    status: 200,
  ...
  async getDashboardStats(
    @Query("environment") environment?: "development" | "staging" | "production"
  ) {
    return await this.alertService.getDashboardStats(environment);
  }
  ...
  @ApiOperation({
    ...
    description:
      "Check SSL certificate for a single domain without adding to monitoring",
  })
  @ApiResponse({
    status: 200,
  ...
  @ApiOperation({
    ...
    description:
      "Check SSL certificates for multiple domains without adding to monitoring",
  })
  @ApiResponse({
    status: 200,
  ...
  async checkMultipleDomains(
    @Body(ValidationPipe) bulkCheckDto: BulkCheckDomainsDto
  ) {
  ...
  @ApiOperation({
    ...
    description:
      "Update SSL information for all monitored domains (SUPER_ADMIN only)",
  })
  @ApiResponse({
    status: 200,
  ...
  @ApiOperation({
    ...
    description:
      "Update SSL information for a single monitored domain (SUPER_ADMIN only)",
  })
  @ApiResponse({
    status: 200,
